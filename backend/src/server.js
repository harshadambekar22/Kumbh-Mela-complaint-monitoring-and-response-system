...
// Default includes 5173 and 5174 so Vite still works when 5173 is already taken.
const ALLOWED_ORIGINS = (process.env.FRONTEND_URLS || process.env.FRONTEND_URL || "http://localhost:5173,http://localhost:5174")
  .split(",")
