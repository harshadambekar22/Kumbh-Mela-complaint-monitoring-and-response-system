...
const BG = "https://images.unsplash.com/photo-1524492449090-1f0f25c00b7b?auto=format&fit=crop&w=1400&q=80";
        ...
        <View style={styles.card}>
          ...
          {mode === "register" && (
            <>
              ...
              <TextInput
                placeholder="Role (operator / department_officer)"
                value={role}
          ...
          <Pressable style={styles.secondaryButton} onPress={() => setMode((m) => (m === "login" ? "register" : "login"))}>
